"""Модуль отвечает за создание персонажа игры."""
...
def attack(char_name, char_class):
    ...
    Генерирует в зависимости от выбранного типа персонажа
...
>>>>>>> 27c13d83cea39db9e27da11fabef952e695612a7
